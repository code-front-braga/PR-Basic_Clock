...
import { formatSeasonMessage, formatTimeComponent, getSeasonOfYear, getTimeDetails, getTimeOfDayPeriod, } from './util.js';
...
export function updateSeasonInfo() {
    ...
    const seasonImgElement = document.querySelector('.img-season');
